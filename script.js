...
let headerLinkA = document.getElementById("linkA");
let headerLinkB = document.getElementById("linkB");
...
headerLinkB.style.transition = "1s";
headerLinkA.style.transition = "1s";
...
workClick = function(){
    ...
    headerLinkA.style.color = "#313715";
    headerLinkB.style.color = "#313715";
    work.style.zIndex = "1";
    fun.style.zIndex = "0";
    workP.style.top = "0px";
...
funClick = function(){
    ...
    headerLinkA.style.color = "#D16014";
    headerLinkB.style.color = "#D16014";
    fun.style.zIndex = "1";
    work.style.zIndex = "0"
    funP.style.top = "0px";
...
revertToStart = function(){
    ...
    headerLinkA.style.color = null;
    headerLinkB.style.color = null;
